...
ggplot(plot.aid, aes(x=year, y=(total / 1000000000))) + 
  geom_line() +
  labs(x=NULL, y="Total ODA commitments (billions of USD)") +
...
ggplot(plot.aid.contentiousness, aes(x=year, y=perc)) + 
  geom_line() +
...
ggplot(plot.aid.us, aes(x=year, y=(total / 1000000000))) + 
  geom_line() +
  labs(x=NULL, y="Total US ODA commitments (billions of USD)") +
  scale_y_continuous(labels=scales::dollar) +
  theme_donors()
```

### Proporition of US aid to types of NGOs
...
ggplot(plot.usaid.channel, aes(x=year, y=perc, colour=channel.clean)) + 
  geom_line() +
  scale_y_continuous(labels=scales::percent) + 
...
pandoc.table(dcjw.indexes, keep.line.breaks=TRUE, style="grid", justify="lll")
```
...
ggplot(df.restrictions.type, aes(x=year, y=y, colour=barrier)) +
  ...
  guides(colour=guide_legend(title="Barriers to"),
         fill=guide_legend(title="Barriers to")) +
  theme_donors()
```
...
ggplot(df.csre.plot, aes(x=year, y=y)) +
