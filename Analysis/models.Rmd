...
fig.coefs.h1 <- ggplot(coefs.raw.h1, aes(y=term_plot, x=estimate, colour=model.name)) + 
...
fig.save.cairo(fig.coefs.h1, filename="fig-coefs-h1",
               width=7, height=2.5)
```
...
fig.save.cairo(fig.simulated.h1.barriers.both, filename="fig-simulated-h1",
               width=6.5, height=4)
```
...
fig.coefs.h2 <- ggplot(coefs.raw.h2, aes(y=term_plot, x=or, colour=model.name)) + 
...
fig.save.cairo(fig.coefs.h2, filename="fig-coefs-h2",
               width=7, height=2.5)
```
...
fig.coefs.h3 <- ggplot(coefs.h3.both, aes(y=term_plot, x=or, 
...
fig.save.cairo(fig.coefs.h3, filename="fig-coefs-h3",
               width=7, height=3)
```
...
fig.save.cairo(fig.simulated.h3.barriers, filename="fig-simulated-h3",
               width=6.5, height=2.5)
```
...
fig.coefs.h4 <- ggplot(coefs.raw.h4, aes(y=term_plot, x=estimate, colour=model.name)) + 
  geom_vline(xintercept=0, colour="grey50", size=0.5) + 
  geom_pointrangeh(aes(xmin=conf.low, xmax=conf.high), size=.5) + 
  labs(x="Estimate", y=NULL) +
  scale_colour_manual(values=model.colors) +
...
fig.save.cairo(fig.coefs.h4, filename="fig-coefs-h4",
               width=4, height=2.5)
```
...
fig.save.cairo(fig.simulated.h4.barriers.both, filename="fig-simulated-h4",
               width=6.5, height=4)
```
