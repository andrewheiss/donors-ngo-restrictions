...
stargazer.fake(mods.h3.dom.next_year.melded, exponentiate=TRUE)
```
...
stargazer.fake(mods.h3.foreign.next_year.melded, exponentiate=TRUE)
```
...
```{r plot-h4-coefs, fig.width=7, fig.height=4}
vars.to.plot <- c("barriers.total_within", "barriers.total_between",
                  "barriers.total_new",
                  "advocacy_within", "advocacy_between", 
                  "entry_within", "entry_between", 
...
stargazer.fake(mods.h4.next_year.melded)
```
...
fig.simulated.h4.barriers <- ggplot(df.plot.data, aes(x=barriers.total_within, 
                                                     y=expm1(value), group=cowcode)) + 
  geom_vline(xintercept=0, size=0.5) +
  geom_smooth(method="lm", size=0.1, alpha=0.1, colour="#DB9E36") +
  geom_smooth(data=df.plot.data.mean, size=1.5, method="lm", colour="#BD4932") +
