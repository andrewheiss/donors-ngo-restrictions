...
We varied the number of datasets we imputed (*m* = 5 and *m* = 10) and found only trivial differences in coefficients between 5 and 10 datasets (as predicted by King et al.). In the interest of computational efficiency and speed, we impute 5 datasets.
...
vars.to.ignore.in.imputation <- country.aid.data.pre.transformation %>%
  select(year, cowcode,
         ...
         natural_disaster.total.affected, col.ind.date)
