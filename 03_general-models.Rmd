...
coefs.to.ignore <- names(mod.test.fe$coefficients) %>% 
  .[contains("cowcode", vars = .)]

huxreg(mod.test.fe, mod.test.re, mod.test.re.fancy, 
       omit_coefs = coefs.to.ignore,
...
mods.robust.neutral.regs.raw <- df.country.aid.demean.next_year.all %>%
  nest(-m) %>%
  mutate(mod.h1.neutral.reg = data %>% map(mod.h1.neutral.reg,
                                           "total.oda_log_next_year"),
         mod.h1.neutral.fund = data %>% map(mod.h1.neutral.fund,
                                            "total.oda_log_next_year"),
         mod.h2.neutral.reg = data %>% map(mod.h2.neutral.reg,
                                           "prop.contentious_logit_next_year"),
         mod.h2.neutral.fund = data %>% map(mod.h2.neutral.fund,
                                            "prop.contentious_logit_next_year"))

mods.robust.neutral.regs.raw.h3 <- df.country.aid.us.demean.next_year.both %>%
  nest(-m) %>%
  mutate(mod.h3.dom.neutral.reg = data %>% map(mod.h3.dom.neutral.reg,
                                               "prop.ngo.dom_logit_next_year"),
         mod.h3.dom.neutral.fund = data %>% map(mod.h3.dom.neutral.fund,
                                                "prop.ngo.dom_logit_next_year"),
         mod.h3.for.neutral.reg = data %>% map(mod.h3.for.neutral.reg,
                                               "prop.ngo.foreign_logit_next_year"),
         mod.h3.for.neutral.fund = data %>% map(mod.h3.for.neutral.fund,
                                                "prop.ngo.foreign_logit_next_year"))
...
mods.h1.after_2.raw <- df.country.aid.demean.after_2.impute %>%
  ...
  mutate(mod.h1.barriers.total = data %>% 
         ...
         mod.h1.barriers.new = data %>% 
           future_map(mod.h1.barriers.new, "total.oda_log_next_year"),
         mod.h1.type.total = data %>% 
           future_map(mod.h1.type.total, "total.oda_log_next_year"),
         mod.h1.type.new = data %>% 
           future_map(mod.h1.type.new, "total.oda_log_next_year"),
         mod.h1.csre = data %>% 
...
mods.h2.after_2.raw <- df.country.aid.demean.after_2.impute %>%
  ...
  mutate(mod.h2.barriers.total = data %>% 
         ...
         mod.h2.barriers.new = data %>% 
           future_map(mod.h2.barriers.new, "prop.contentious_logit_next_year"),
         mod.h2.type.total = data %>% 
           future_map(mod.h2.type.total, "prop.contentious_logit_next_year"),
         mod.h2.type.new = data %>% 
           future_map(mod.h2.type.new, "prop.contentious_logit_next_year"),
         mod.h2.csre = data %>% 
